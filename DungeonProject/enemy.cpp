...
void LargeSkeleton::printSelf()
{
    ...
    t->put(ColorString(R"(  _,_\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(  /7/Y/^\\\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString("  vuVV|C)|            )", skeletoncolor) + ColorString(R"(            __ _\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(    \\|^ /          )", headcolor) + ColorString(R"(             .'  Y '>,\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(    )| \\)       )", headcolor) + ColorString(R"(               / _   _   \\\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(   //)|\\\\     )", headcolor) + ColorString(R"(                 )(_) (_)(|}\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(  / ^| \\ \\    )", headcolor) + ColorString(R"(                 {  4A   } /\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"( //^| || \\\\   )", headcolor) + ColorString(R"(                  \\uLuJJ/\\l\n)", skeletoncolor), vcursor); vcursor.y++;
    const int TOP_CURSOR_Y = vcursor.y;
    t->put(ColorString(R"(>//||| |\\\\\\|   )", headcolor) + ColorString(R"(                 |3    p)/\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(| \"\"\"\"\"  7/>l )", headcolor) + ColorString(R"(__ _____ ____      /nnm_n//\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(L>_   _-< 7/|)", headcolor) + ColorString(R"(_-__,__-)\\,__)(\".  \\_>-<_/D\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"()D\" Y \"c)  9)  )", headcolor) + ColorString(R"(     //V     \\_\"-._.__G<D     __\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(\\  ||    . _/ )", headcolor) + ColorString(R"(      (       \\ \"-._\"> G<D-_.-\"_=)_\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"( ) __   / /  )", headcolor) + ColorString(R"(       \"      _/.__ />_c__.-__<\"/ ( \\\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"( | | |  |(|  )", headcolor) + ColorString(R"(             < \"-._\"> _.G_.___)\\   \\7\\\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(  \\\"=\" // |   )", headcolor) + ColorString(R"(           (,\"-.__.|\\ \\<.__.-\" )   \\ \\\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(   '---'  |     )", headcolor) + ColorString(R"(         |,\"-.__\"| \\!\"-.__.-\".\\   \\ \\\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(     |_;._/    )", headcolor) + ColorString(R"(          (_\"-.__\"'\\ \\\"-.__.-\".|    \\_\\\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(     )(\" V     )", headcolor) + ColorString(R"(           \\\"-.__\"'|\\ \\-.__.-\".)     \\ \\\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(        (     )", headcolor) + ColorString(R"(             \"-.__'\"\\_\\ \\.__.-\"./      \\ l\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(         )          )", headcolor) + ColorString(R"(        \".__\"\">>G\\ \\__.-\">        V )\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(                                \"\"  G<\\ \\_.-\"        ./7\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(                                     G<\\ \\          ///\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(                                ___  G<D\\ \\        /7^\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(                              /\".-_\"-\"G\"<\\ \\__    ///))\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(                              ||,-_ \"     '.\\_\"- /// (\\\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(                              | (_)  _   \"/ __7 |X/   V\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(                             /\\__\"\"-/ \"\\ _\"\"c_\"GBV\n)", skeletoncolor), vcursor); vcursor.y++;
    t->put(ColorString(R"(                            _)(  \"\"'    \"--.c__>D'\n)", skeletoncolor), vcursor); vcursor.y++;
