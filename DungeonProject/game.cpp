...
void Game::titleScreen()
{
    ...
    vwin->putcen(ColorString("The Harp of the Gods v1.3.1", dngutil::GREEN), vwin->txtmacs.DIVIDER_LINES[0] + 1);
...
void Game::backgroundStory()
{
    ...
    t->putcen(ColorString("The Demon Lord Zorlock rose from the Demon Realm and attacked Bora", dngutil::WHITE), topOfText, true);
    Sleep(onelineTime);
    tm->clearLine(topOfText);
